...
Les contraintes sont aussi vérifiées lors de l'appel à la méthode `Doc::store()`. Une paramètre optionnel à cette méthode permet de ne pas vérifier les contraintes.
